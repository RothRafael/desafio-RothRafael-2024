...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve rejeitar quantidade inválida e animal inválido', () => {
        const resultado = new RecintosZoo().analisaRecintos('MACACOLEAO', -2);
        expect(resultado.erro).toBe("Animal e quantidade inválidos");
        expect(resultado.recintosViaveis).toBeFalsy();
